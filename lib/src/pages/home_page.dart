...
class _HomePageState extends State<HomePage> {
    ...
    return Container(
      ...
      child: Row(
        ...
        children: <Widget>[
          ...
          Text(
              "Completa las siguientes secuencias graficas ordenando las figuras y acertar dichas secuencias",
      ...
      child: Row(
        ...
        children: <Widget>[
          ...
          Container(
            ...
            child: (secuencia.isNotEmpty)
                ? _imagenProcesada(secuencia[0])
                : Container(),
          ),
          SizedBox(
            width: 10.0,
          ...
          Container(
            ...
            decoration: BoxDecoration(
                border: Border.all(color: Colors.black, width: 2.0)),
            child: (secuencia.length > 1)
                ? _imagenProcesada(secuencia[1])
                : Container(),
          ),
          SizedBox(
            width: 10.0,
          ...
          Container(
            ...
            decoration: BoxDecoration(
                border: Border.all(color: Colors.black, width: 2.0)),
            child: (secuencia.length > 2)
                ? _imagenProcesada(secuencia[2])
                : Container(),
          ),
        ],
      ),
  ...
  void _validar() {
    setState(() {
      if (secuencia.elementAt(0) == 'triangulo3' &&
          secuencia.elementAt(1) == 'triangulo1' &&
          secuencia.elementAt(2) == 'triangulo2') {
        validado = true;
      } else {
        validado = false;
      }
